...
| [src/__init__.py](../src/__init__.py) | Supporting research module. |
| [src/analysis/__init__.py](../src/analysis/__init__.py) | Analysis module for Gulf Hazard Interview research. |
...
| [src/analysis/run_mediation_analysis.py](../src/analysis/run_mediation_analysis.py) | Estimate natural direct and indirect effects for the Gulf Interview Project. |
...
| [r_analysis/analyze_insurance_models.R](../r_analysis/analyze_insurance_models.R) | R analysis/inference module; see its source for required inputs. |
| [r_analysis/run_cluster_inference.R](../r_analysis/run_cluster_inference.R) | R analysis/inference module; see its source for required inputs. |
| [r_analysis/run_hurricane_coverage_sensitivity.R](../r_analysis/run_hurricane_coverage_sensitivity.R) | R analysis/inference module; see its source for required inputs. |
| [r_analysis/run_measurement_invariance.R](../r_analysis/run_measurement_invariance.R) | R analysis/inference module; see its source for required inputs. |
| [r_analysis/run_missingness_and_mi.R](../r_analysis/run_missingness_and_mi.R) | R analysis/inference module; see its source for required inputs. |
